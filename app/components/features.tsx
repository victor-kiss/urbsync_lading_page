...
import { containerVariants, itemFromLeftVariants } from "@/app/animations/variants";
...
export const Features = ({ steps, fields }: FeaturesProps) => (
  ...
  >
    {/* Ajuste de classes Tailwind:
      - bg-gradient-to-r: sintaxe padrão estável.
      - from-transparent / to-transparent: garantem que o grid rosa apareça nas pontas.
      - via-blue-600/30: um azul mais visível que o 950, com opacidade controlada.
    */}
    <div className="absolute inset-0 bg-linear-to-r from-transparent via-emerald-800/30 to-transparent z-10 pointer-events-none" aria-hidden="true" />
    ...
    <div className="w-full sm:max-w-7xl flex flex-col items-center justify-center gap-y-10 z-20 ">
      ...
      >
        <div className="mb-8">
          ...
          <p className="text-gray-400 text-sm mt-1">A UrbSync mapeia automaticamente todos os campos críticos.</p>
        </div>
