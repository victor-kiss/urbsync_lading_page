...
export const Features = ({ steps, fields }: FeaturesProps) => (
  ...
  <section
    ...
    style={{
      ...
      backgroundImage: "radial-gradient(at 94% 30%, #34d399 0, transparent 14%), radial-gradient(at 2% 50%, #022c22 0, transparent 18%), radial-gradient(at 100% 80%, #064e3b 0, transparent 19%)",
    }}
  >
